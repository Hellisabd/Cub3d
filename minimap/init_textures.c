...
/*   Updated: 2024/07/11 13:45:58 by amirloup         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	init_mini_map(t_cub *cub, t_mini_map *mini_map)
{
	...
	mlx_resize_image(mini_map->player_i, mini_map->size_wall_x, \
		mini_map->size_wall_y);
	mlx_resize_image(mini_map->wall_i, mini_map->size_wall_x, \
		mini_map->size_wall_y);
	mlx_resize_image(mini_map->door_i, mini_map->size_wall_x, \
		mini_map->size_wall_y);
